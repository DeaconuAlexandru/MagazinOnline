...
$txt = [
    'ro'=>[
        ...
        'collection'=>[
         ['name'=>'Mochete dreptunghiulare ale păcii','type'=>'Mochete dreptunghiulare ale PsyGeometry','price'=>'','img'=>'Image39.png','link'=>'Colectie.php#PsyGeometry'],
        ['name'=>'Îngeraș ai păcii','type'=>'Cadoul care transmite mai mult decât cuvinte','price'=>'','img'=>'Image61.png','link'=>'Colectie.php#Ingerasi'],
        ['name'=>'Mandale ale păcii','type'=>'Armonie vizuală care îți liniștește mintea','price'=>'','img'=>'Image71.png','link'=>'Colectie.php#Mandala'],
        ['name'=>'Tablouri ale păcii','type'=>'Arta care dă viață pereților tăi','price'=>'','img'=>'Image123.png','link'=>'Colectie.php#Tablouri'],
        ...
        'about_quote'=>'„Fiecare Obiect de Putere spune o poveste despre necesitatea de a fi Pace la nivel Mondial.Misiunea noastră este să aducem aceste povești în casa ta.” — Serghei Danișin, Nicoleta Iliin și Adrian Pop
            Fondatori! —',
