...
$txt = [
    'ro'=>[
        ...
        'about_quote'=>'„Fiecare Obiect de Putere spune o poveste despre necesitatea de a fi Pace la nivel Mondial.Misiunea noastră este să aducem aceste povești în casa ta.” — Sherghei Danisin și Nicoleta Lilin
            Fondatori! —',
...
foreach (($txt[$lang]['buttons'] ?? []) as $btn) {
    ...
    $href = $isColectie ? 'Colectie.php' : '#collection';
