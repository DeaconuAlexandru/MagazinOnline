...
$txt = [
    'ro'=>[
        ...
        'services'=>[
            ...
            ['title'=>'Livrare contra cost','desc'=>'Livrare contra cost pentru comenzi și transport servicii curățare.'],
        ...
        'collection'=>[
            ['name'=>'Covor PsyGeometry Royal','type'=>'Tradițional','price'=>'','img'=>'Image4.png'],
            ['name'=>'Covor PsyGeometry Abstract','type'=>'Contemporan','price'=>'','img'=>'Image15.png'],
            ['name'=>'Covor PsyGeometry Clasic','type'=>'Tradițional','price'=>'','img'=>'Image12.png']
        ],
        ...
        'about_features'=>['Experiență vastă în productia de covoare','Materiale de cea mai înaltă calitate','Echipă de meșteri specializați','Garanție pentru toate produsele','Consultanță personalizată gratuită','Prețuri competitive'],
...
.hero{
  ...
  text-align: center;
  padding: 120px 20px;
  background-image: url('images/hero-bg.jpg'); /* schimbă calea dacă nu e corectă */
        ...
        <?php if(!empty($feedbacks)): ?>
            <?php foreach($feedbacks as $fb): ?>
                <div class="feedback-card">
                    <p><strong><?= htmlspecialchars($fb['author_name'] ?? ($fb['name'] ?? 'Utilizator')) ?></strong>
  ...
  <div class="about-wrapper">
    ...
    <div class="about-image-box">
        ...
        <div class="about-badge">
            <strong>Avem o experiență vastă</strong>
            <span>Suntem de neoprit</span>
        </div>
    </div>
