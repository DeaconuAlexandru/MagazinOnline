...
<div class="container">
    ...
    <div class="checkout-steps">
        ...
        <!-- pickup-template actualizat, link spre Easyboxes.php -->
        <div id="pickup-template" style="display:none">
          <div class="pickup-summary">
            <p class="pickup-title">Ridicare personala din:</p>
            <p class="pickup-subtitle" id="pickup-name">Punct EasyBox selectat</p>
            <p class="pickup-address pickup-address-view" id="pickup-address">Se verifică punctul EasyBox</p>
            <p class="pickup-co2">95% mai putin CO2</p>
            <a href="Easyboxes.php" id="choose-easybox-link" class="btn-use change-pickup-btn">Alege alt punct</a>
          </div>
        </div>
		</form>
