...
<div class="container">
    ...
    <div class="checkout-steps">
        ...
        <div id="courier-template" style="display:none">
         ...
         <!-- Ridicare personala easybox - Template -->
                <div id="pickup-template" style="display:none">
                    <p>Ridicare personală din:</p>
                    <strong id="easybox-name"></strong>
                    <p id="easybox-address"></p>
                    <p>95% mai puțin CO₂</p>
                    <button type="button" class="change-pickup-btn" id="change-pickup-btn">
                        Alege alt punct
                    </button>
                </div>
...
document.addEventListener('DOMContentLoaded', () => {
    const pickupListNew   = document.getElementById('pickup-list');
    const addPickupBtn    = document.getElementById('add-pickup-btn');
    const pickupModal     = document.getElementById('pickup-modal');
    const closePickupModal= document.getElementById('close-pickup-modal');
    const backToList      = document.getElementById('back-to-list');
    const pickupSection   = document.getElementById('pickup-section');

    // -------------------------
    function addBoxToListAndMap(box) {
        ...
        pickupListNew.appendChild(li);

        li.addEventListener('click', () => {
            document.getElementById('shipping_method').value = 'easybox';
            document.getElementById('pickup_location').value = `${box.name} | ${box.address}, ${box.city}, ${box.county}`;
            document.getElementById('easybox-name').textContent = box.name;
            document.getElementById('easybox-address').textContent = `${box.address}, ${box.city}, ${box.county}`;
    ...
    // -------------------------
    // Functie simpla pentru Ridicare personală
    document.querySelectorAll('.card-option').forEach(card => {
        card.addEventListener('click', () => {
            if (card.dataset.shipping === 'pickup') {
                // Ascunde curierul
                if (pickupSection) pickupSection.style.display = 'block';
                document.getElementById('shipping_method').value = 'pickup';
                document.getElementById('easybox-name').textContent = 'Ridicare personală';
                document.getElementById('easybox-address').textContent = 'Alege un punct de ridicare';
                document.getElementById('pickup_location').value = 'Ridicare personală';
            } else {
                if (pickupSection) pickupSection.style.display = 'none';
            }
        });
